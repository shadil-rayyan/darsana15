...
const SkillDevelopementProgramKey = () => {
  ...
  return (
    <div className="w-full relative bg-www-equalopp-org-1349x593-default-nero overflow-hidden flex flex-col items-end justify-start pt-0.5 pb-0 pr-8 pl-0 box-border gap-[772px] leading-[normal] tracking-[normal] mq450:gap-[193px] mq750:gap-[386px]">
      <section className="w-[1387px] flex flex-col items-start justify-start py-0 pr-0 pl-5 box-border gap-[104px] max-w-full text-center text-sm text-gray1-100 font-h3 mq450:gap-[26px] mq750:gap-[52px]">
        ...
        <h2 className="m-0 self-stretch relative text-5xl font-normal font-arial text-black text-left mq450:text-lgi">
          ...
          interviews. In 2008, we jointly launched this program with the
          college's placement cell, and the students responded positively. The
          skill development program has grown significantly over time.
        </h2>
      </section>
