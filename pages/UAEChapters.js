...
const UAEChapters = () => {
  ...
  return (
    <div className="w-full h-[2408px] relative bg-www-equalopp-org-1349x593-default-nero overflow-hidden flex flex-col items-start justify-start pt-0.5 px-0 pb-8 box-border gap-[139.6px] leading-[normal] tracking-[normal] text-center text-base text-black font-h3 mq450:gap-[35px] mq800:gap-[70px] mq1125:h-auto">
      <section className="mt-[-334px] self-stretch flex flex-row items-start justify-end pt-0 px-0 pb-[134.4px] box-border max-w-full text-left text-base text-gray1-300 font-nunito">
        <div className="w-[1400px] flex flex-row items-end justify-between py-0 pr-0 pl-5 box-border top-[0] z-[99] sticky gap-[20px] max-w-full">
          <img
      ...
      <section className="self-stretch flex flex-row items-start justify-start pt-0 pb-[33.4px] pr-11 pl-[47px] box-border max-w-full shrink-0 text-left text-29xl text-black font-h3 mq800:pl-[23px] mq800:pr-[22px] mq800:box-border">
        <div className="flex-1 flex flex-col items-start justify-start gap-[85px] max-w-full mq450:gap-[21px] mq800:gap-[42px]">
          <header className="w-[1263px] flex flex-row items-start justify-between pt-0 px-0 pb-[13.1px] box-border max-w-full gap-[20px] text-center text-sm text-gray1-100 font-h3 mq1125:flex-wrap">
            ...
            <div className="w-[1306px] flex flex-col items-end justify-start gap-[56px] max-w-full mq800:gap-[28px]">
              <div className="w-[897px] flex flex-row items-start justify-between gap-[20px] max-w-full mq450:flex-wrap">
                <div className="flex flex-col items-start justify-start pt-[36.9px] px-0 pb-0">
                  <h1 className="m-0 relative text-inherit leading-[58px] font-extrabold font-inherit inline-block min-w-[91px] mq450:text-10xl mq450:leading-[35px] mq800:text-19xl mq800:leading-[46px]">
                    UAE
                  </h1>
                </div>
                <div className="w-[219px] flex flex-row items-start justify-start relative text-base">
                  ...
                  <div className="flex-1 rounded-8xs flex flex-row items-end justify-start py-[23px] px-[25px] gap-[32px] text-5xl border-[1px] border-solid border-black">
                    ...
                    <div className="flex flex-col items-start justify-end pt-0 px-0 pb-[4.1px]">
                      <img
                        className="w-[9.8px] h-[4.2px] relative z-[1]"
                        alt=""
                        src="/icon1.svg"
                      />
                    </div>
              ...
              <div className="self-stretch flex flex-row items-start justify-start max-w-full">
                <img
                  ...
                  loading="lazy"
                  alt=""
                  src="/uae--chapter-hero-image@2x.png"
                />
              </div>
            </div>
          </div>
          <div className="w-[1096px] flex flex-row items-start justify-start py-0 px-[29px] box-border max-w-full text-5xl">
            <h3 className="m-0 flex-1 relative text-inherit font-normal font-inherit inline-block max-w-full mq450:text-lgi">
              <p className="m-0">
                Darsana UAE chapter has 161 members, about 21 prospective
                members are identified and shall be invited to become members.
              </p>
              <p className="m-0">
                - Raag Malhar: An online musical event was conducted on 26th
                November 21.Members, and family from all the chapters across the
                globe participated in the event.
              </p>
              <p className="m-0">
                - Technos Zest 21: Technos Zest, a family fun sports event on
                the technos platform in Dubai, on 10th December 2021. Darsana
                played a leadership role in organizing the event, The highest
                participation in the event was also by darsana.
              </p>
              <p className="m-0">
                - Dhow cruise: A dhow cruise trip was conducted in Dubai on 27th
                March 22, for the members and family. The participation for the
                event was overwhelming.
              </p>
              <p className="m-0">
                - UAE Sangamam 2022: The Ninth Darsana UAE Sangamam was held on
                12th June 2022. 64 members attended the function. Chief Guest of
                the function was Dr. Jayan Jose Thomas IAS  and special guest of
                the function was Com. Niranjan TG.
              </p>
            </h3>
          </div>
        </div>
      ...
      <section className="w-[1373px] flex flex-row items-start justify-center py-0 px-5 box-border max-w-full shrink-0 text-left text-xl text-black font-h3">
        <div className="w-[1199px] shadow-[0px_94px_200px_rgba(21,_21,_21,_0.15)] flex flex-row flex-wrap items-start justify-start relative gap-[38px] max-w-full mq800:gap-[19px]">
          <img
      ...
      <section className="w-[1416px] flex flex-row items-start justify-center py-0 px-5 box-border max-w-full text-left text-13xl text-black font-h3">
        <div className="w-[996px] flex flex-row flex-wrap items-center justify-center gap-[48px] max-w-full mq800:gap-[24px]">
      ...
      <section className="w-[1379px] bg-www-equalopp-org-1349x593-default-nero flex flex-row items-end justify-start pt-5 pb-6 pr-[29.5px] pl-[394px] box-border gap-[199px] max-w-full text-left text-base text-black font-h3 mq450:gap-[25px] mq450:pl-5 mq450:box-border mq800:gap-[50px] mq800:pl-[98px] mq800:box-border mq1350:flex-wrap mq1350:gap-[99px] mq1350:justify-center mq1350:pl-[197px] mq1350:box-border">
