  ...
  return (
    <div className="self-stretch flex flex-col items-start justify-start gap-[43px] max-w-full text-center text-xs text-black font-raleway mq750:gap-[21px]">
      ...
      <div className="self-stretch flex flex-row items-start justify-end max-w-full text-left">
        <div className="w-[1140px] flex flex-row items-start justify-center gap-[54px] max-w-full mq1050:flex-wrap mq750:gap-[27px]">
          <div className="w-[521px] relative tracking-[1px] leading-[27px] flex items-center shrink-0 min-w-[521px] max-w-full z-[1] mq1050:flex-1 mq750:min-w-full">
