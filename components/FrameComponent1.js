const FrameComponent1 = () => {
  return (
    <div className="w-[1208.2px] flex flex-row items-start justify-start py-0 pr-[63px] pl-[63.1px] box-border max-w-full text-left text-13xl text-black font-arial lg:pl-[31px] lg:pr-[31px] lg:box-border">
